...
$(document).ready(function() {
    var token = getToken();
    $.get({ url: "https://discordapp.com/api/users/@me", headers: { "Authorization": "Bearer " + token } }, function(data) {
        $(".u-a").attr('src', "https://cdn.discordapp.com/avatars/" + data.id + "/1faa3eed98189f795fda0674e9b96c29.png")
        $("#u-n").text("Hello " + data.username + "!");
    });
    $.get({ url: "https://discordapp.com/api/users/@me/guilds", headers: { "Authorization": "Bearer " + token } }, function(data) {
        console.log(data);
